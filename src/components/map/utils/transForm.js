...
export const cesiumTomapbox = (map, viewer) => {
  const { center, zoom, bearing, pitch } = updateView(viewer)
  map.jumpTo({
    center,
    zoom,
    bearing,
...
export const mapboxToCesium = (map, viewer) => {
  ...
  let cameraPitch = Cesium.Math.toRadians(pitch - 90)
  ...
  // let lookTarget = Cesium.Cartesian3.fromDegrees(longitude, latitude，height);
...
// 参考URL
// https://juejin.cn/post/7240263755698946085
// https://github.com/limzgiser/cesium-mapboxgl-syncamera
